...
public interface IUploadService
{
    ...
    Task<UploadJobDto?> GetJobAsync(Guid id, DataScopeDto scope, CancellationToken ct = default);
    Task<SaveTemplateResponse> SaveTemplateAsync(Guid jobId, SaveTemplateRequest request, string actorUsername, DataScopeDto scope, CancellationToken ct = default);
