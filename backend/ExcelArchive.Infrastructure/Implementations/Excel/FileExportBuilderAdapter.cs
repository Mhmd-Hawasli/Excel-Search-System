...
{
    public byte[] Build(string sheetName, IReadOnlyList<string> headers, IReadOnlyList<ExportRecordDto> records, IReadOnlyList<ExportEditDto> edits, bool markEdits = false, string? nationalIdHeader = null)
