...
- `records`: `id`, `file_id` FK cascade، `row_index`, `data` JSONB، `created_at`. أعمدة raw: `sf_first_name`, `sf_father_name`, `sf_last_name`, `sf_full_name`, `sf_national_id`, `sf_sham_cash`, `sf_personal_no`, `sf_mother_name`, `sf_phone`, `sf_contract_code`, `sf_secondary_contract_code`. أعمدة نص مطبع: `n_first_name`, `n_father_name`, `n_last_name`, `n_full_name`, `n_mother_name`, `n_contract_code`, `n_secondary_contract_code`. أعمدة أرقام: `d_national_id` (digits-only padded إلى 11), `d_sham_cash`, `d_personal_no`, `d_phone`; و`national_id_num` BIGINT nullable.
...
الرقم الوطني يخزن بثلاث صور: الأصل في `sf_national_id`، digits-only padded إلى 11 في `d_national_id` وهو المعروض والمبحوث، وBIGINT في `national_id_num` أو NULL إذا لا أرقام أو أكثر من 11. القيمة المشوهة لا توقف import وتولد issue.
...
- الخطأ الوطني: 1–8 أرقام، 12 خانة فأكثر، أو محارف غير رقمية؛ يقبل 9–11 رقماً والأرقام العربية والفارسية. الشام كاش: أقل/أكثر من 16 خانة أو محارف. الفراغ مستقل في البيانات الناقصة.
